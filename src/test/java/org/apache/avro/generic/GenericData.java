...
public class GenericData {
  ...
  private Object deepCopyRaw(Schema schema, Object value) {
    ...
    switch (schema.getType()) {
      case ARRAY:
        ...
        List<Object> arrayCopy = new org.apache.avro.generic.GenericData.Array<Object>(
  ...
  public Object createFixed(Object old, Schema schema) {
    if ((old instanceof GenericFixed)
      ...
      return old;
    return new org.apache.avro.generic.GenericData.Fixed(schema);
  }
   ...
   * a {@link org.apache.avro.generic.GenericData.Record}.
   */
